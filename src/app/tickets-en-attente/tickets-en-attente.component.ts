...
@Component({
  selector: 'app-tickets-en-attente',
  templateUrl: './tickets-en-attente.component.html',
  styleUrls: ['./tickets-en-attente.component.css']
})
export class TicketsEnAttenteComponent {
dtOptions:Config={};
...
ngOnInit(){
  ...
  this.apiService.get_Tickets(1).subscribe(
    (response)=>{
