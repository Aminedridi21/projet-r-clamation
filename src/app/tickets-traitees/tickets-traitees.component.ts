...
@Component({
  selector: 'app-tickets-traitees', 
  templateUrl: './tickets-traitees.component.html',
  styleUrl: './tickets-traitees.component.css'
})
export class TicketsTraiteesComponent {
  dtOptions:Config={};
  ...
  ngOnInit(){
    ...
    this.apiService.get_Tickets(3).subscribe(
      (response)=>{
